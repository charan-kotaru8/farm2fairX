...
from app.api.farmer_recommendations import router as farmer_rec_router
...
app = FastAPI(
    title="Farm2Fair API",
    description="API for the Farm2Fair Platform — AI/ML-driven (regression + weighted scoring) + FPO Aggregation + Logistics & Storage + Admin & Grievances, with daily-live Agmarknet data",
    version="0.7.0",
)
...
app.include_router(farmer_rec_router, tags=["ai"])
