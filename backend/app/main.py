...
app = FastAPI(
    title="Farm2Fair API",
    description="API for the Farm2Fair Platform — Hybrid statistical + rule-based AI + FPO Aggregation",
    version="0.5.0",
)
...
@app.get("/")
def read_root():
    return {"message": "Welcome to Farm2Fair API v0.5 — FPO Aggregation & AI Intelligence enabled"}
